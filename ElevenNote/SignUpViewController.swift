...
// ****** This file is obsolete for now and is not required with the Parse framework.  Should a customized log in/sign up file be needed in the future, this is a rough framework that could be used.  It will need revision, including a "Keep Me Signed In" option.  
